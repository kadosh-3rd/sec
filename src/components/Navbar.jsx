...
const Navbar = () => {
	...
	const activeLink = norm + ' text-amber-700 font-bold';
		...
		<header className='sticky top-0 z-10'>
			<nav className='px-8 py-8 flex justify-between items-center bg-white'>
				...
				<div className='lg:hidden absolute right-12'>
					<button
						className='navbar-burger flex items-center text-amber-600 p-3'
				...
				>
					...
					<li>
						<Link
							className={
								pathname === '/prerequisites' ? activeLink : inactiveLink
							}
							to='/prerequisites'
						>
							Pré-requis
					...
					<li>
						<Link
							className={pathname === '/demo' ? activeLink : inactiveLink}
							to='/demo'
						>
							Cas Pratique
						</Link>
					...
					<li>
						<Link
							className={pathname === '/protocol' ? activeLink : inactiveLink}
							to='/protocol'
						>
							Protocole
						</Link>
				...
				<div>
					<BtnConnect
						actionType='Sign In'
						complement='lg:ml-auto lg:mr-3 bg-gray-100 hover:bg-gray-200 text-gray-900'
						goTo='signIn'
					/>
					<BtnConnect
						actionType='Sign Up'
						complement='bg-amber-700 hover:bg-amber-800 text-white'
						goTo='signUp'
					/>
				</div>
			</nav>
